...
async function send_request(user_input) {
  ...
  const url = `http://localhost:8080/api/hello?query=${encodeURIComponent(user_input)}`;

  //const url = `https://team404-sql-agent-971987703066.europe-north1.run.app/api/hello?query=${encodeURIComponent(user_input)}`;
  try {
